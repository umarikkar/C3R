...
from data.hpa_dataset_single import ImageFolderMask
...
def train_one_epoch(student, teacher, teacher_without_ddp, ibot_loss, data_loader,
    ...
    for it, (images, labels, masks) in enumerate(metric_logger.log_every(data_loader, len(data_loader)//20, header)):
...
if __name__ == '__main__':
    ...
    args.output_dir = os.path.join(os.getcwd(), 'results/pretrain_basic', args.output_dir)
